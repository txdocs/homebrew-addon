...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.7.0.zip", :using => :curl
  sha256 "1dbcfc16675cdf6654e60c9cd6ff8347bcee4e042f9903f3b8c9d7add690fc8f"
  license "Apache-2.0"
