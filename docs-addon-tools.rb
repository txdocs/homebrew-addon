...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v0.5.309.zip", :using => :curl
  sha256 "befff19c6d39401a61667b487a5f41b09e77807f9afd1f9eaf634546720d1e05"
  license "Apache-2.0"
