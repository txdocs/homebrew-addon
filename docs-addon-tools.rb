...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v0.5.428.zip", :using => :curl
  sha256 "476e1e4be098d333d8bc573873675660123d210ea5c7826a8c00c32280f70508"
  license "Apache-2.0"
