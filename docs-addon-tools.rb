...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.10.0.zip", :using => :curl
  sha256 "ba12f54927db57d627947e728715d0a050e994c690adb7acecbcbc599c96e43b"
  license "Apache-2.0"
