...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.12.0.zip", :using => :curl
  sha256 "054dd8a7116cdda0eb42eaff8392a815c92f7bd16c68bdbcdeb69289c9620bc4"
  license "Apache-2.0"
