...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v0.5.304.zip", :using => :curl
  sha256 "a66941a2921529ad0dbea9133f8f37fcafdea90a442c36f30254fd6c3a9a42ba"
  license "Apache-2.0"
