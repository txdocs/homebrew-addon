...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v0.5.314.zip", :using => :curl
  sha256 "6aae1e1701cebd4001e1c425222078ffd6bff6e2361ec506f997093ddf08c186"
  license "Apache-2.0"
