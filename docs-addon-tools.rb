...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.8.0.zip", :using => :curl
  sha256 "9675f4c80c08b693ff397b5a04848736d333c676babf27b8473e0dc573432c59"
  license "Apache-2.0"
