...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.14.0.zip", :using => :curl
  sha256 "ad9322ecd738ee1ff2a88bd9454389a79d91ceebfe0d0f5276cf367a7459fc8f"
  license "Apache-2.0"
