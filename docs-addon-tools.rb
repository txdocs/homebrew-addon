...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.6.0.zip", :using => :curl
  sha256 "8a2fc78bbd9089f7048753b36fce456feafbd8978db30cd9aba50832fc940d16"
  license "Apache-2.0"
