...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v1.15.0.zip", :using => :curl
  sha256 "6263c7ffc2263b2c7e6cd096e7eb7a42908bc83c6704bde0cd09885fcf71213c"
  license "Apache-2.0"
