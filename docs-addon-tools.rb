...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v0.5.609.zip", :using => :curl
  sha256 "3fa64920083c8d64384fec363fb8b94b6c9a2063c6317a291af3868cc726f1ed"
  license "Apache-2.0"
