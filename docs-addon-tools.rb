...
class DocsAddonTools < Formula
  desc "插件开发工具"
  homepage ""
  url "https://cdn.addon.tencentsuite.com/addon-tools/beta/docs-addon-tools-macos-v0.5.323.zip", :using => :curl
  sha256 "6b6a6fb7aabe2f390819c268c778d1cd20abac14d9b0596ea83a0c011a97f65d"
  license "Apache-2.0"
